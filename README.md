...
\hline
\textbf{Model} & \textbf{Test AUC} & \textbf{Test AUC CI} & \textbf{Test SE} & \textbf{Return Period} \\
\hline
random (Baseline) & 0.4751 & (0.4101, 0.5372) & 0.0328 & 1-Day \\
finance\_only (Baseline) & 0.4782 & (0.4132, 0.5437) & 0.0330 & 1-Day \\
tfidf (Baseline) & 0.5239 & (0.4603, 0.5907) & 0.0334 & 1-Day \\
finance\_tfidf (Baseline) & 0.4630 & (0.4022, 0.5302) & 0.0332 & 1-Day \\
...
finance\_only (Baseline) & 0.4614 & (0.3907, 0.5256) & 0.0334 & 5-Day \\
tfidf (Baseline) & 0.6207 & (0.5599, 0.6796) & 0.0306 & 5-Day \\
finance\_tfidf (Baseline) & 0.5406 & (0.4780, 0.6034) & 0.0325 & 5-Day \\
